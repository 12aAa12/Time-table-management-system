...
public class Depatment extends javax.swing.JFrame {
    public Depatment() {
        initComponents();
    }
    private void initComponents() {
        ...
        jLabel1.setText("DEPARTMENTNAME");
        ...
        jLabel2.setText("     WELCOME TO LPU TIME TABLE MANAGEMENT SYSTEM");
    ...
    dt.setValueAt(DEPARTMENTNAME,index,0);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Depatment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
